                    ...
                    <section className="admin-analytics">
                        ...
                        <div className="admin-analytics__grid">
                            ...
                            <div className="admin-analytics__group">
                                ...
                                {/* Action Ecom */}
                                <div className="admin-analytics__block">
                                    <h4>Engagement Boutique</h4>
                                    <div className="admin-analytics__list">
                                        <div className="admin-analytics__row">
                                            <label>👁️ Articles Consultés:</label>
                                            <span className="admin-analytics__value">
                            ...
                            {/* --- GROUPE 3: ACTIVITÉS DU SANCTUAIRE --- */}
                            <div className="admin-analytics__group">
                                <h3 className="admin-analytics__group-title">🛐 Activités du Sanctuaire</h3>

                                <div className="admin-analytics__block">
                                    <h4>Suivi des Réservations</h4>
                                    <div className="admin-analytics__list">
                                        <div className="admin-analytics__row">
                                            <label>Intérêt (Bouton cliqué):</label>
                                            <span className="admin-analytics__value admin-analytics__value--blue">
                                                {stats.gaData.engagement?.begin_reservation || 0}
                                            </span>
                                        </div>
                                        <div className="admin-analytics__row" title="Réservations enregistrées dans la base de données ces 30 derniers jours">
                                            <label>Reçues (30j):</label>
                                            <span className="admin-analytics__value admin-analytics__value--green">
                                                {stats.recentReservations || 0}
                                            </span>
                                        </div>
                                        <div className="admin-analytics__row">
                                            <label>Total Historique:</label>
                                            <span className="admin-analytics__value">
                            ...
                            {/* --- GROUPE 4: GÉNÉROSITÉ & ÉCOLE --- */}
                            <div className="admin-analytics__group">
                                <h3 className="admin-analytics__group-title">🎓 Générosité & École</h3>
                                <div className="admin-analytics__block">
                                    <h4>Dons & Soutiens</h4>
                                    <div className="admin-analytics__list">
                                        <div className="admin-analytics__row">
                                            <label>Intention (Clic bouton):</label>
                                            <span className="admin-analytics__value">
                                                {stats.gaData.engagement?.begin_donation || 0}
                                            </span>
                                        </div>
                                        <div className="admin-analytics__row">
                                            <label>Dons Validés (30j):</label>
                                            <span className="admin-analytics__value admin-analytics__value--green">
