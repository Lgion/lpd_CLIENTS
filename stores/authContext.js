...
export const AuthContextProvider = ({children}) => {
    ...
    , mainmenu = [
        {id:"accueil",href:"/",title:"Librairie religieuse chrétienne Abidjan, Ecommerce chrétien, centre de retraite spirituelle à Bolobi (entre azaguié et yakasseme)",content:"Accueil",tagzone:["librairie","librairie religieuse","librairie religieuse chrétienne", "ecommerce chrétien", "sanctuaire bolobi", "retraites spirituelles"],titrePage:["Sanctuaire Notre Dame du Rosaire de Bolobi"],sns:{"Puissance Divine d'Amour d'Abidjan Cocody 2plateaux rue des jardins":"https://www.facebook.com/genevieve.achi/"},search:"librairie+chrétienne+abidjan+cocody+2plateau"},
        ...
        {id:"bolobi",href:"/bolobi-ecole-caritative-larve-msn",title:"Bolobi: école gratuite d'Adzopé, culture du poivre, élevage de mouches soldat noire, activités spirituelles religieuses chrétien catholique et protestant",content:"Oeuvre Caritatives",tagzone:["école caritative", "école saint martin de porèz de bolobi"],titrePage:["L'école St Martin de Porèz de Bolobi, et les activités religieuses caritatives et économiques du sanctuaire de Bolobi"],sns:{"École St Martin de Porèz de Bolobi": "https://www.facebook.com/abidjan.puissance.divine/"},search:"école+primaire+saint+martin+porès+bolobi+azaguié+yakasseme"},
