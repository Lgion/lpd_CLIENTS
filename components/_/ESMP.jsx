...
export default function ESMP() {
  return (
    <article className='esmp'>
        ...
        <section>
          <svg title="Nourriture" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-piggy-bank" viewBox="0 0 16 16">
          ...
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod, non? Et omnis similique, magnam dolor autem hic ex, nemo enim mollitia quia neque facilis sequi dolorem perferendis, inventore reiciendis iste?
          </p>
          <svg title="H\xE9bergement" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-pin-map-fill" viewBox="0 0 16 16">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-bug-fill" viewBox="0 0 16 16">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-calendar-heart" viewBox="0 0 16 16">
